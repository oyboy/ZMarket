    ...
    if (loading) {
        return (
            <div className="relative">
                <div className="h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full mb-8 animate-pulse" />

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {Array.from({ length: 8 }).map((_, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden animate-pulse"
                        >
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full w-2/3" />
            ...
            <div className="relative">
                ...
                <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                    ...
                    <p className="text-gray-600 max-w-md mb-6 font-['Inter']">
                        Пока что в этой категории нет товаров. Загляните позже или
                        посмотрите другие категории.
                    </p>
